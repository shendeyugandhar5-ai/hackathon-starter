    ...
    return {
      ...
      sprintPace: {
        currentWeek: Math.min(
          8,
          Math.max(1, Math.ceil((overallScore / 100) * 8)),
        ),
        totalWeeks: 8,
      },
      velocity: {
      ...
      milestones: [
        {
          week: "W1",
          title: "Mathematical Foundations & Probability",
          status: overallScore >= 30 ? "completed" : "in-progress",
        },
        {
          week: "W2",
          title: "Bayes Reasoning & Classification Models",
          status:
            overallScore >= 50
              ? "completed"
              : overallScore >= 25
        ...
        {
          week: "W3",
          title: "Graph Algorithms & Relational Indexing",
          status:
            overallScore >= 70
              ? "completed"
              : overallScore >= 45
        ...
        {
          week: "W4",
          title: "Neural Architectures & Loss Geometry",
          status:
            overallScore >= 85
              ? "completed"
              : overallScore >= 65
        ...
        {
          week: "W5",
          title: "System Design & Scalable ML Pipelines",
          status: overallScore >= 95 ? "completed" : "upcoming",
        },
        {
          week: "W6-8",
          title: "Placement Capstones & Mock Socratic Salons",
          status: "upcoming",
        },
      ],
    };
