      ...
      <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-[#F5EFEB] via-[#EFE7DE] to-[#E8DDD0] p-12 lg:p-16 flex-col justify-between border-r border-[#E2DAD0] relative overflow-hidden">
        ...
        <div className="my-auto max-w-lg z-10">
          ...
          <p className="mt-5 text-sm lg:text-base text-[#57534E] leading-relaxed">
            Your tutors remember where you left off. Every question,
            misconception, and mastery score is synchronized across your
            specialist AI team.
          </p>
        </div>
        ...
        <div className="my-auto py-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label
                htmlFor="login-email"
                className="block text-xs font-semibold text-[#1C1917] mb-1.5 font-sans"
              >
                Academic Email
              </label>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 bg-white border border-[#EAE5DC] rounded-lg text-sm text-[#1C1917] placeholder-[#A8A29E] focus:outline-none focus:ring-2 focus:ring-[#A8421E]/30 focus:border-[#A8421E] transition-all font-mono disabled:opacity-60"
                />
              </div>
            </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                <label
                  ...
                  className="text-xs font-semibold text-[#1C1917] font-sans"
                >
                  Password
                </label>
                ...
                <button
                  ...
                  className="text-xs font-semibold text-[#A8421E] hover:underline cursor-pointer"
                >
                  Forgot password?
                </button>
              </div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••••••"
                  disabled={isSubmitting || isGoogleSubmitting}
                  className="w-full pl-10 pr-10 py-2.5 bg-white border border-[#EAE5DC] rounded-lg text-sm text-[#1C1917] placeholder-[#A8A29E] focus:outline-none focus:ring-2 focus:ring-[#A8421E]/30 focus:border-[#A8421E] transition-all font-mono disabled:opacity-60"
                />
            ...
            <div className="flex items-center pt-1">
              ...
              <label
                htmlFor="remember-me"
                className="ml-2 text-xs text-[#57534E] select-none cursor-pointer"
              >
