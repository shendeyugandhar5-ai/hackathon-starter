...
export default function KnowledgeMap() {
  ...
  const activeNodeScore = activeNode.score ?? activeNode.baseScore ?? 0;
  const activeNodeState =
    activeNode.state || activeNode.defaultState || "learning";
  const nodeScore = (id, fallback = 0) =>
    nodes.find((node) => node.id === id)?.score ?? fallback;
  const nodeState = (id, fallback = "learning") =>
    nodes.find((node) => node.id === id)?.state ?? fallback;
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 pt-6 space-y-6">
        ...
        <div>
          ...
          <p className="mt-1 text-xs md:text-sm text-[#57534E] max-w-3xl leading-relaxed">
            Explore interconnected concept dependencies across Data Science &
            Computer Science curricula. Visualized in real time by the EduHive
            Coordinator Agent.
          </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          ...
          <div className="lg:col-span-8 space-y-4">
            ...
            <div className="bg-white rounded-xl border border-[#EAE5DC] shadow-[0_1px_3px_rgba(0,0,0,0.02)] p-4 md:p-5 flex flex-col justify-between">
              ...
              <div className="my-4 relative bg-[#FCFAF7] rounded-xl border border-[#EAE5DC] p-4 overflow-hidden select-none min-h-[380px] flex items-center justify-center">
                <svg viewBox="0 0 680 340" className="w-full h-auto">
                  ...
                  {/* Lineage Splines */}
                  <path
                    d="M 190,95 C 240,95 250,110 290,115"
                    fill="none"
                    stroke="#B93826"
                    strokeWidth="2"
                    strokeDasharray="3,3"
                    markerEnd="url(#arrow-red-active)"
                  ...
                  />
                  <path
                    d="M 340,240 C 340,190 340,165 340,145"
                    fill="none"
                    stroke="#D1CCC5"
                    strokeWidth="1.5"
                    strokeDasharray="3,3"
                  ...
                  />
                  <path
                    d="M 400,115 C 440,115 450,105 480,95"
                    fill="none"
                    stroke="#B93826"
                    strokeWidth="2"
                    strokeDasharray="4,3"
                  ...
                  />
                  <path
                    d="M 570,95 C 590,95 600,105 615,115"
                    fill="none"
                    stroke="#D1CCC5"
                    strokeWidth="1.5"
                    strokeDasharray="3,3"
                  ...
                  />
                  <path
                    d="M 540,240 C 580,220 600,170 625,145"
                    fill="none"
                    stroke="#D1CCC5"
                    strokeWidth="1.5"
                    strokeDasharray="3,3"
                  ...
                  <g
                    ...
                    onClick={() => setSelectedNodeId("sql_indexing")}
                  >
                    <rect
                      x="90"
                      y="240"
                    ...
                    <text
                      ...
                      y="257"
                      textAnchor="middle"
                      className="text-[10px] font-semibold fill-[#1C1917]"
                    >
                      ✓ SQL Indexing
                    </text>
                    <text
                      ...
                      y="271"
                      textAnchor="middle"
                      className="text-[8px] font-mono font-bold fill-[#2E7D52]"
                    >
                      {nodeState("sql_indexing") === "mastered"
                        ? "MASTERED"
                        : "LEARNING"}{" "}
                      {nodeScore("sql_indexing", 0)}%
                    </text>
                  </g>
                  ...
                  <g
                    className="cursor-pointer"
                    onClick={() => setSelectedNodeId("dp_knapsack")}
                  >
                    <rect
                      x="290"
                      y="240"
                    ...
                    <text
                      ...
                      y="271"
                      textAnchor="middle"
                      className="text-[8px] font-mono font-bold fill-[#C07D1C]"
                    >
                      {nodeState("dp_knapsack") === "mastered"
                        ? "MASTERED"
                        : "LEARNING"}{" "}
                      {nodeScore("dp_knapsack", 0)}%
                    </text>
                  </g>
                  ...
                  <g
                    className="cursor-pointer"
                    onClick={() => setSelectedNodeId("loss_gradient")}
                  >
                    <rect
                      x="490"
                      y="240"
                    ...
                    <text
                      ...
                      className="text-[8px] font-mono font-bold fill-[#2E7D52]"
                    >
                      {nodeState("loss_gradient") === "mastered"
                        ? "MASTERED"
                        : "LEARNING"}{" "}
                      {nodeScore("loss_gradient", 0)}%
                    </text>
                  </g>
                  ...
                  >
                    ...
                    <text
                      ...
                      y="109"
                      textAnchor="middle"
                      className="text-[10px] font-bold fill-[#B93826]"
                    >
                      ! Conditional Prob.
                    </text>
                    <text
                      ...
                      y="120"
                      textAnchor="middle"
                      className="text-[7.5px] font-mono fill-[#8C827A]"
                    >
                      ONT-MTH-PR-024
                    </text>
                    <rect
                    ...
                    <text
                      ...
                      y="132.5"
                      textAnchor="middle"
                      className="text-[7px] font-mono font-bold fill-white tracking-wide"
                    >
                      {activeNode.id === "cond_prob"
                        ? `${activeNodeState.toUpperCase()} ${activeNodeScore}%`
                        : `CRITICAL ${nodeScore("cond_prob", 0)}% WEAK`}
                    </text>
                  </g>
                  ...
                  <g
                    className="cursor-pointer"
                    onClick={() => setSelectedNodeId("bayes_rule")}
                  >
                    <rect
                      x="475"
                      y="75"
                    ...
                    <text
                      ...
                      className="text-[8px] font-mono font-bold fill-[#C07D1C]"
                    >
                      {nodeState("bayes_rule") === "mastered"
                        ? "MASTERED"
                        : "LEARNING"}{" "}
                      {nodeScore("bayes_rule", 0)}%
                    </text>
                  </g>
                  ...
                  <g
                    className="cursor-pointer"
                    onClick={() => setSelectedNodeId("naive_bayes")}
                  >
                    <rect
                      x="580"
                      y="115"
                    ...
                    <text
                      ...
                      y="132"
                      textAnchor="middle"
                      className="text-[10px] font-semibold fill-[#57534E]"
                    >
                      ○ Naive Bayes
                    </text>
                    <text
                      ...
                      y="146"
                      textAnchor="middle"
                      className="text-[8px] font-mono fill-[#8C827A]"
                    >
                      TARGET CAPSTONE
                    </text>
                  </g>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              <div className="bg-white p-4 rounded-xl border border-[#EAE5DC] shadow-2xs space-y-1">
                ...
                <div className="font-serif text-lg text-[#B93826] font-normal">
                  {bottlenecks.length || 1} Critical Barrier
                </div>
                <p className="text-[11px] text-[#57534E]">
                  Conditional independence definition blocks Naive Bayes
                  progression.
                </p>
              </div>
              <div className="bg-white p-4 rounded-xl border border-[#EAE5DC] shadow-2xs space-y-1">
                ...
                <div className="font-serif text-lg text-[#2E7D52] font-normal">
                  +14% / Wk
                </div>
                <p className="text-[11px] text-[#57534E]">
                  Paced to complete Machine Learning capstone by Sprint Week 4.
                </p>
              </div>
              <div className="bg-white p-4 rounded-xl border border-[#EAE5DC] shadow-2xs space-y-1">
                <span className="text-[10px] font-mono uppercase tracking-wider text-[#8C827A] font-semibold">
                ...
                <div className="font-serif text-lg text-[#1C1917] font-normal">
                  Active Socratic Splicing
                </div>
                <p className="text-[11px] text-[#57534E]">
                  Coordinator dispatches Maths + AIML tutors in tandem.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-4 bg-white rounded-xl border border-[#EAE5DC] shadow-[0_1px_3px_rgba(0,0,0,0.02)] p-5 space-y-5">
            <div className="flex items-center justify-between pb-3 border-b border-[#F0ECE1]">
              ...
              <span
                className={`text-[10px] font-mono font-bold px-2 py-0.5 rounded uppercase border ${
                  activeNodeState === "mastered"
                    ? "bg-[#EAF4EE] text-[#2E7D52] border-[#CDE5D5]"
                    : activeNodeState === "learning"
                      ? "bg-[#FCF4E6] text-[#C07D1C] border-[#F2D8B3]"
            ...
            <div className="space-y-3 pt-2 border-t border-[#F0ECE1] text-xs">
              <div>
                <span className="text-[10px] font-mono text-[#8C827A] uppercase font-semibold">
                  Prerequisites:
                </span>
                <div className="flex flex-wrap gap-1.5 mt-1">
                  {activeNode.prerequisites.map((p) => (
                    <span
                      key={p}
                      className="px-2 py-0.5 rounded bg-[#FAF7F2] border border-[#EAE5DC] text-[11px] font-mono text-[#57534E]"
                    >
                      {p.replace(/_/g, " ")}
                    </span>
                  ))}
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-1.5 mt-1">
                  {activeNode.unlocks.map((u) => (
                    <span
                      key={u}
                      className="px-2 py-0.5 rounded bg-[#FDF2EE] border border-[#FADCD1] text-[11px] font-mono text-[#A8421E]"
                    >
                      {u.replace(/_/g, " ")}
                    </span>
                  ))}
